---
name: ai
description: Main router for the ai hub. For story/epic requests, route to multiple sub-hubs when needed.
---
...
4. In each chosen sub-hub: open SKILL.md, read routing.csv, select skills per sub-problem.
